...
namespace BabyBattery
{
    [StaticConstructorOnStartup]
    public class Building_BabyBattery : Building
    {
        private const float MinEnergyToExplode = 400f;
        ...
        private static readonly Vector2 BarSize = new Vector2(0.5f, 0.25f);
        ...
        public override void Draw()
        {
            ...
            r.size = Building_BabyBattery.BarSize;
            r.fillPercent = comp.StoredEnergy / comp.Props.storedEnergyMax;
            r.filledMat = Building_BabyBattery.BatteryBarFilledMat;
            r.unfilledMat = Building_BabyBattery.BatteryBarUnfilledMat;
            r.margin = 0.15f;
        ...
        {
            if (!base.Destroyed && this.ticksToExplode == 0 && dinfo.Def == DamageDefOf.Flame && Rand.Value < 0.05f && base.GetComp<CompPowerBattery>().StoredEnergy > MinEnergyToExplode)
            {
